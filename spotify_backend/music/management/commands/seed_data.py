...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        seeder.add_entity(Artist, number, {
            ...
            'profile_picture': lambda x: None,  # Đặt giá trị None để bỏ qua
        })
        ...
        seeder.add_entity(Album, number, {
            ...
            'cover_image': lambda x: None,  # Bỏ qua CloudinaryField
        })
        ...
        seeder.add_entity(Song, number, {
            ...
            'song_image': lambda x: None,  # Bỏ qua CloudinaryField
